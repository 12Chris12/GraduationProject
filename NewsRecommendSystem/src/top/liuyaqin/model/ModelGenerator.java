...
public class ModelGenerator
{
	...
	{
		// base model 所使用的包名
		String baseModelPackageName = "top.liuyaqin.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getRootClassPath() + "/top/liuyaqin/model/base";
		System.out.println("rootclasspath:"+baseModelOutputDir);
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "top.liuyaqin.model";
